...
public final class MedicCapItem extends ArmorItem {
    public MedicCapItem(ArmorMaterial material, Properties properties) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return "smartmobs:textures/models/armor/medic_cap_layer_1.png";
    }
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entity, ItemStack stack,
                ...
                HumanoidModel<LivingEntity> model = new MedicCapModel<>(Minecraft.getInstance()
                        .getEntityModels().bakeLayer(MedicCapModel.LAYER));
