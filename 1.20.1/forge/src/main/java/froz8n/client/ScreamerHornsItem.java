...
public final class ScreamerHornsItem extends ArmorItem {
    public ScreamerHornsItem(ArmorMaterial material, Properties properties) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return "smartmobs:textures/models/armor/screamer_horns_layer_1.png";
    }
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entity, ItemStack stack,
                ...
                HumanoidModel<LivingEntity> model = new ScreamerHornsModel<>(Minecraft.getInstance()
                        .getEntityModels().bakeLayer(ScreamerHornsModel.LAYER));
