...
public final class SapperCapItem extends ArmorItem {
    public SapperCapItem(ArmorMaterial material, Properties properties) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return "smartmobs:textures/models/armor/sapper_cap_layer_1.png";
    }
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entity, ItemStack stack,
                ...
                HumanoidModel<LivingEntity> model = new SapperCapModel<>(Minecraft.getInstance()
                        .getEntityModels().bakeLayer(SapperCapModel.LAYER));
