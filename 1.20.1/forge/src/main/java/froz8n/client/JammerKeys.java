...
public final class JammerKeys {
    ...
    public static void registerInput(){
        MinecraftForge.EVENT_BUS.addListener(JammerKeys::onKey);
        MinecraftForge.EVENT_BUS.addListener(JammerKeys::onScroll);
    }
    ...
    private static void setMode(int mode){
        froz8n.combat.SoundWaveNetwork.setMode(mode);
    }
}