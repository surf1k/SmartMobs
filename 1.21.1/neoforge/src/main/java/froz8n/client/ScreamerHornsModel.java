...
public final class ScreamerHornsModel<T extends LivingEntity> extends HumanoidModel<T> {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(SmartMobs.MODID, "screamer_horns"), "main");
