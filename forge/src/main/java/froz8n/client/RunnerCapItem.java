...
public final class RunnerCapItem extends Item {
    public RunnerCapItem(Properties properties) {
        super(properties);
    }
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntityRenderState state, ItemStack stack,
                ...
                return new RunnerCapModel<>(Minecraft.getInstance().getEntityModels()
                        .bakeLayer(RunnerCapModel.LAYER));
            }
        });
    }
}
